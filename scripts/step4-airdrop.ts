 ...
 * STEP 4
 *
 * This will run the entire airdrop based on the contract from step 3 and CSV export from step 2. First this will deploy
...
async function main(): Promise<void> {
	...
	// set the variables
	let tokenContractAddress = "0xc196E98F3D0c2e973A33B0f7768Ee501dec43350"; //TODO replace with deployment from step 3
	const pbloAirdropArtifactName = "PBLOAirdrop";
	const completeAirdropWithAdjustmentsPath = `${__dirname}/../data/airdropWithAdjustmentsCSV-1625873919517 (2nd run).csv`;
	const chunkSize = 115
